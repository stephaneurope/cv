<?php 
   ...
   <section id="about" class="container-fluid">
        ...
        <div class="heading">
                <h1>Besoins d'un site internet?</h1>
...
<p>Chaque projet web est unique et mérite d’être décrypté avant de pouvoir faire l’objet d’une proposition accompagnée d’un devis personnalisé.</p>
